    ...
    <div class="container py-4">
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <input type="text" class="form-control" id="tituloVaga" v-model="titulo">
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <textarea type="text" class="form-control" id="descricaoVaga" v-model="descricao"></textarea>
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <input type="number" class="form-control" id="salarioVaga" v-model="salario">
    ...
    methods: {
        salvarVaga() {
            ...
            vagas.push({
                ...
                tipo: this.tipo,
                publicacao: dataAtual.toISOString() // data e hora no timezone UTC
            })
            ...
            if(this.validaFormulario()) {
                ...
                this.emitter.emit('alerta', {
                    ...
                    descricao: 'Parece que você esqueceu de preencher alguma informação. Faça o ajuste e tente novamente.'
                })
            }
        },
