<template>
    <div class="h-100 p-5 bg-lighy border rounded-3">
        <h2>Pesquisar vagas</h2>

        <div class="row">
            <div class="col">
                <div class="form-group">
                    <label for="tituloDaVaga">Título da vaga</label>
                    <input type="text" class="form-control" id="tituloDaVaga" placeholder="Pesquise por palavras chaves, por exemplo 'PHP', 'Pleno', 'Analista'" v-model="titulo">
